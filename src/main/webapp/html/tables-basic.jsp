    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody class="table-border-bottom-0">
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="edit?maSach=${o.maSach}">
                    <i class="ri-pencil-line me-1"></i> Edit
                  </a>
                  <a class="dropdown-item" href="delete?maSach=${o.maSach}">
        ...
        <c:if test="${empty listP}">
          <tr>
            <td colspan="3" class="text-center">Không có sách nào trong danh sách.</td>
          </tr>
        </c:if>
      </tbody>
    </table>
